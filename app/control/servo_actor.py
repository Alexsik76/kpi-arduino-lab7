...
class PanTiltHead:
    ...
    def __init__(self, pico_controller: PicoController):
        ...
        self.pid_tilt = PIDController(kp=0.001, ki=0.0, kd=0.001, output_limit=0.3)
    ...
    def _sync_hardware(self, force: bool = False):
        ...
        pan_changed = abs(self.pan_angle - self.last_sent_pan) > 0.4
        tilt_changed = abs(self.tilt_angle - self.last_sent_tilt) > 0.4
