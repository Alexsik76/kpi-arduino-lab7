...
from fastapi.middleware.cors import CORSMiddleware  # <--- НОВЕ
...
# --- CORS CONFIGURATION (НОВЕ) ---
# Це дозволяє сайтам ззовні (наприклад, GitHub Pages) звертатись до твого API
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # У продакшені тут ставлять конкретний домен, для тестів "*" ок
...
async def health_check():
    """Легкий ендпоінт для перевірки, чи живий робот"""
